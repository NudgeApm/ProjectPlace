...
public class Application extends ObjectBase implements java.io.Serializable  {
	...
	int id;
	String centralBaseName;
	String name;
	String versionCAST;
	ArrayList<Snapshot> listSnapshot = new ArrayList<Snapshot>();
	double maxLocValue;
	...
	public String getVersionCAST() {
		return versionCAST;
	}
	public void setVersionCAST(String versionCAST) {
		this.versionCAST = versionCAST;
	}
