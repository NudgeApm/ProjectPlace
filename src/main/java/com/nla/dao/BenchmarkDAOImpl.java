...
public class BenchmarkDAOImpl implements BenchmarkDAO{
	...
	public void deleteTables(){
		jdbcTemplate.update("DELETE from pocpoc.account");
		jdbcTemplate.update("DELETE from pocpoc.contrat");
	}
	...
	public void insertdata(KbUsr kbUsr) {
		...
		int randomNbInsert = (int)(Math.random() * 10) * 1000;
		...
		int randomNbInsertContrat = (int)(Math.random() * 10) * 1000;
	...
	public void selectStar() {
		int forumId = 1;
		String query = "Select * from pocpoc.account where id <> ? limit 1";
	...
	public void selectOneColumn() {
		int forumId = 1;
		String query = "Select nom from pocpoc.account where id <> ?  limit 1";
