...
import com.nla.domain.EnlightenView;
...
public class ForumDAOImpl implements ForumDAO {
	...
	public void insertForum(KbUsr kbUsr) {
		String query = "INSERT INTO spring3.cast_snapshot(ID, nom) VALUES (?,?)";
...
//		}
	...
	public List<ObjectCAST> getListObjCAST(final String pCentralBaseName,final String pSnapshotIDApplicationID,
		...
		String query = "SELECT DISTINCT results.OBJECT_ID ObjId, obj.OBJECT_FULL_NAME ObjFullname,  results.METRIC_ID MtId,  cqt.METRIC_NAME MtName,  cqt.m_weight,  modObj.object_name modObj, " +
			   ...
			   List<ObjectCAST> objectList =null;
			   try {
